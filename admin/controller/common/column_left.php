...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'extension/module/ocUltra_theme_setting')) {
				$ocUltra[] = array(
					'name'	   => $this->language->get('text_header_setting'),
			...
			if ($this->user->hasPermission('access', 'extension/module/ocUltra_theme_setting')) {
				$ocUltra[] = array(
					'name'	   => $this->language->get('text_slider_setting'),
			...
			if ($this->user->hasPermission('access', 'extension/module/ocUltra_theme_setting')) {
				$ocUltra[] = array(
					'name'	   => $this->language->get('text_footer_setting'),
			...
			if ($this->user->hasPermission('access', 'extension/module/ocUltra_theme_setting')) {
				$ocUltra[] = array(
					'name'	   => $this->language->get('text_product_page_setting'),
			...
			if ($this->user->hasPermission('access', 'extension/module/ocUltra_theme_setting')) {
				$ocUltra[] = array(
					'name'	   => $this->language->get('text_checkout_setting'),
			...
			if ($this->user->hasPermission('access', 'extension/module/ocUltra_theme_setting')) {
				$ocUltra[] = array(
					'name'	   => $this->language->get('text_whatsapp_button'),
			...
			if ($ocUltra) {
				$data['menus'][] = array(
					'id'       => 'menu-ocUltra',
					'icon'	   => 'fa-cog',
					'name'	   => $this->language->get('text_ocUltra_setting'),
					'href'     => '',
					'children' => $ocUltra
				);
			}
